...
import { Bell, ChevronDown, LogOut, Bot } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-end border-b bg-background/80 px-4 backdrop-blur md:px-6">
